    ...
    if (!project) {
        return (
            <div className="container" style={{ padding: '100px 0', textAlign: 'center' }}>
                ...
                <Link to="/project" className="action-btn"><span>Back to Projects</span></Link>
            </div>
        );
    }
                    ...
                    <div className="bloglist__main">
                        <div className="list details">
                            ...
                            <div className="content-d">
                                ...
                                <div className="main">
                                    <p className="boild text-justify">{project.description}</p>

                                    <div className="scrollbar" id="style-14">
                                        <div className="force-overflow">
                                            <div className="image">
                                                <img src={project.mainImage} alt="Client Side View" />
                                            </div>
                                        </div>
                                    </div>

                                    {project.detailsContent.map((text, index) => (
                                        <p key={index} className="mb-15 text-justify">{text}</p>
                                    ))}
                                    ...
                                    <div className="scrollbar" id="style-14">
                                        <div className="force-overflow">
                                            <div className="image">
                                                <img src={project.adminImage} alt="Admin Side View" />
                                            </div>
                                        </div>
                                    </div>

                                    {project.adminContent.map((text, index) => (
                                        <p key={index} className="mb-15 text-justify">{text}</p>
                                    ))}
