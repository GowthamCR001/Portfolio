                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="block-text center">
                                ...
                                <h3 className="heading">Let’s Connect & Collaborate</h3>
                            </div>
                            <div className="touch__main">
                                <div className="info">
                                    ...
                                    <ul className="list">
                                        ...
                                        <li>
                                            ...
                                            <p>gcr.gowthamcr001@gmail.com</p>
                                        </li>
                                    </ul>
                                ...
                                <form action="https://formsubmit.co/gcr.gowthamcr001@gmail.com" method="POST" className="form-box">
                                    <div className="row">
                                        <div className="col">
                                    ...
                                    <div className="row mb-0">
                                        <div className="col">
                                            ...
                                            <button type="submit" className="action-btn"><span>Send Now</span></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
