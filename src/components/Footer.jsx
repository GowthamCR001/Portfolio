                    ...
                    <div className="col-md-12">
                        ...
                        <div className="footer__bottom">
                            <Link to="/" className="logo">
                                <img src="/assets/images/logo/Gcr-logo.png" alt="" style={{ height: '100px' }} />
                            </Link>
                            ...
                            <ul className="list-social">
                                <li><a href="https://www.facebook.com/share/1DpeeEsj2D/" target="_blank" rel="noopener noreferrer">
                                ...
                                <li><a href="https://github.com/GowthamCR001" target="_blank" rel="noopener noreferrer">
                                ...
                                <li><a href="https://www.linkedin.com/in/gowtham-c-r-52934124a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer">
